...
def register_routes(app):
    ...
    # ============================================
    # RUTAS DE GESTION DE CENTROS (Admin)
    # ============================================
    ...
    @app.route('/api/centros/codigo/<string:codigo>', methods=['GET'])
    @token_required
    ...
    @app.route('/api/centros/<int:centro_id>/estadisticas', methods=['GET'])
    @token_required
    ...
    @app.route('/api/centros/<int:centro_id>/reactivar', methods=['PUT'])
    @admin_required
    ...
    @app.route('/api/roles/<int:rol_id>/reactivar', methods=['PUT'])
    @admin_required
    ...
    @app.route('/api/especialidades/id/<int:especialidad_id>/reactivar', methods=['PUT'])
    @admin_required
